...
@Component({
  ...
  templateUrl: './sales-estimation.component.html',
  styleUrls: ['./sales-estimation.component.scss']
})
export class SalesEstimationComponent implements OnInit {
  ...
  //   salesPersonFilteredOptions!: Observable<string[]>;
  ...
  //   customAcCodeListOptions!: Observable<string[]>;
  ...
  //   currentExchangeMetalPurchase = [];
  //   currentExchangeMetalPurchaseGst = [];
  ...
  //   countryMaster: any = [];
  //   countryMasterOptions: Observable<string[]>;
  //   mobileCountryMaster: any = [];
  //   mobileCountryMasterOptions: Observable<string[]>;
  //   stateMaster: any = [];
  //   stateMasterOptions: Observable<string[]>;
  //   cityMaster: any = [];
  //   cityMasterOptions: Observable<string[]>;
  //   nationalityMaster: any = [];
  //   nationalityMasterOptions: Observable<string[]>;
  //   custTypeMaster: any = [];
  //   custTypeMasterOptions: Observable<string[]>;
  //   sourceOfFundList: any[] = [];
  //   sourceOfFundListOptions: Observable<string[]>;
  //   genderList: any = [];
  ...
  //     public comFunc: CommonfuncService,
  ...
  //     // this.suntechApi.companyParamSubject.subscribe((data) => {
  ...
  //     });
  //   }
  //   getRetailEstimationMaster(data) {
  //     this.snackBar.open('Loading...');
  //     this.suntechApi.getRetailEstimationMaster(data).subscribe((res) => {
  ...
  //           retailSaleData.estimationDetail.map((data, index) => {
  //             console.log(
  //               '===============retailSalesDetails====================='
  //             );
  ...
  //         )
  //           retailSReturnData.retailSReturnDetails.map((data, index) => {
  //             console.log(
  ...
  //         )
  //           metalPurchaseData.metalPurchaseDetails.map((data, index) => {
  //             console.log(
  //               '============metalPurchaseDetail========================'
  //             );
  //             console.log(data, index);
  ...
  //       var data = this.all_branch.map((t) => t.BRANCH_CODE);
  ...
  //               }
  //             }
  //             this.karatRateDetails.sort((a, b) =>
  ...
  //     this.genderList.forEach((data) => data.ENGLISH = data.ENGLISH.toUpperCase())
  //     console.log('genderList', this.genderList);
  
  //   }
  //   changeKaratRate(value, index) {
  ...
  //         console.log(this.receiptEditId);
  //         console.log('====================================');
  //         const preitemIndex = this.receiptDetailsList.findIndex((data) => {
  ...
  //   open(content, salesReturnEdit = false, receiptItemData = null, custForm = false) {
  ...
  //       (preVal, curVal) => parseFloat(preVal) + parseFloat(curVal.total_amount),
  //       0
  //     );
  ...
  //     this.suntechApi.getSalesPersonMaster().subscribe((resp) => {
  ...
  //         // var data = resp.response.map((t) => t.SALESPERSON_CODE);
  ...
  //           );
  //       } else {
  //         this.salesPersonFilteredOptions = null;
  //       }
  //     });
  //   }
  ...
  //         this.suntechApi[apiCtrl](posCustomer).subscribe(async (data) => {
  ...
  //                   // console.log(data = data.toString().replace(/\\"/g, ''));
  //                   console.log('====================================');
  ...
  //       });
  //       // }
  //       this.suntechApi.getPosCustomerList(_cust_mobile_no).subscribe((resp) => {
  //         console.log(resp);
  //         // console.log(resp.Message);
  //         this.amlNameValidationData = false;
  ...
  //   //   );
  //   // }
  //   private _filterMasters(arrName, value, optVal1, optVal2 = null): any[] {
  //     const filterValue = (value || '').toLowerCase();
  //     return arrName.filter((option) => {
  //       const val1 = option[optVal1] || '';
  //       const val2 = option[optVal2] || '';
  //       return (
  //         val1.toLowerCase().includes(filterValue) ||
  //         val2.toLowerCase().includes(filterValue)
  //       );
  //     });
  //   }
  ...
  //         )
  //       );
  //     this.mobileCountryMaster = this.comFunc.countryMaster.filter(data => data.MOBILECOUNTRYCODE != '');
  ...
  //         // this.all_sales_person = resp;
  //         var data = _data.map((t) => t.STOCK_CODE);
  ...
  //     this.suntechApi.getCreditCardMaster().subscribe((resp) => {
  //       console.log(resp);
  //       // console.log(resp.Message);
  ...
  //       recModeCash = _resp.filter(function (value) {
  //         return (
  //           value.MODE == 0 &&
  ...
  //       recModeCC = _resp.filter(function (value) {
  //         return (
  //           value.MODE == 1 &&
  //           (value.CC_BRANCHCODE == '' || value.CC_BRANCHCODE == userBranch)
  //         );
  ...
  //       recModeOthers = _resp.filter(function (value) {
  //         return (
  //           value.MODE == 2 &&
  //           (value.CC_BRANCHCODE == '' || value.CC_BRANCHCODE == userBranch)
  //         );
  ...
  //       recModeAdvance = _resp.filter(function (value) {
  //         return (
  //           value.MODE == 3 &&
  //           (value.CC_BRANCHCODE == '' || value.CC_BRANCHCODE == userBranch)
  //         );
  //       });
  //       recModeGift = _resp.filter(function (value) {
  //         return (
  //           value.MODE == 4 &&
  //           (value.CC_BRANCHCODE == '' || value.CC_BRANCHCODE == userBranch)
  //         );
  ...
  //       this.recMode_Cash_Data = recModeCash.map((t) => t.CREDIT_CODE);
  ...
  //       this.recMode_CC_Data = recModeCC.map((t) => t.CREDIT_CODE);
  ...
  //       this.recModeOthersData = recModeOthers.map((t) => t.CREDIT_CODE);
  ...
  //       this.recModeAdvanceData = recModeAdvance.map((t) => t.CREDIT_CODE);
  ...
  //       this.recModeGiftData = recModeGift.map((t) => t.CREDIT_CODE);
  ...
  //   private _filterReceiptModes(arrName,
  //     value: string,): string[] {
  //     const filterValue = (value || '').toLowerCase();
  //     return arrName.filter((option) =>
  //       option.toLowerCase().includes(filterValue)
  ...
  //   setSalesReturnItems(slno, items) {
  //     // alert('data');
  ...
  //         (data) => data.SRNO == temp_sales_return_items.SRNO
  //       );
  //       // alert(preitemIndex);
  //       if (preitemIndex != -1) {
  ...
  //     this.setSalesReturnDetailsPostData();
  //   }
  //   checkSelectedVal(stockCode, amtval, srNo) {
  ...
  //     );
  //   }
  //   changeRetailSalesReturnVal(value) {
  ...
  //     }
  //   }
  //   addSalesReturnOnSelect(event, slsReturn, index) {
  //     // console.table(event);
  ...
  //   setExchangeMetalItems(slno, data) {
  ...
  //   setExchangeMetalGstItems(slno, items) {
  ...
  //       let _karatCode;
  //       this.suntechApi
  //         .getRetailsalesExchangeLookup(this.strBranchcode, _exchangeCode)
  //         .subscribe((resp) => {
  ...
  //               this.removeValidationsForforms('exchangeForm', [
  ...
  //   removeValidationsForforms(form, controlsArr) {
  //     controlsArr.map((data) => {
  ...
  //     } else {
  //       const preitemIndex = this.currentLineItems.findIndex((data) => {
  //         // console.table(data);
  ...
  //   }
  //   setRetailSalesRowData(sno, data) {
  //     let temp_pos_item_data: any = {
  //       DIVISIONMS: data.DIVISIONMS,
  ...
  //     const preitemIndex = this.salesReturnsItems_forVoc.findIndex((data) => data.SRNO.toString() == this.salesReturnRowDataSRNO.toString());
  //     if (preitemIndex != -1) {
  ...
  //     this.sales_returns_items.forEach(function (item) {
  ...
  //     if (event.target.value != '') {
  //       this.suntechApi
  //         .getRetailSReturnLookUp(branch, voc_type, voc_no, fin_year)
  //         .subscribe((resp) => {
  //           if (resp.status == 'Failed') {
  //             // alert('Invalid Data');
  ...
  //   }
  //   convertDateWithTimeZero(date) {
  //     return date.split('T')[0] + 'T00:00:00.000Z';
  //   }
  //   convertDateToYMD(str) {
  //     var date = new Date(str),
  //       mnth = ('0' + (date.getMonth() + 1)).slice(-2),
  //       day = ('0' + date.getDate()).slice(-2);
  ...
  //       this.removeValidationsForforms('lineItemForm', ['fcn_li_pcs']);
  ...
  //   }
  //   setKaratList() {
  //     this.karatRateDetails.map((data, i) => {
  ...
  //       if (this.editOnly) {
  //         this.suntechApi
  //           .updateRetailEstimationMaster(this.queryParams, postData)
  //           .subscribe(
  //             (res) => {
  //               this.snackBar.dismiss();
  //               // try {
  ...
  //           );
  //       } else {
  //         this.suntechApi.postRetailEstimationMaster(postData).subscribe(
  //           (res) => {
  //             this.snackBar.dismiss();
  //             // try {
  //             if (res != null) {
  ...
  //     }
  //   }
  //   openDialog(title, msg, okBtn, swapColor = false) {
  ...
  //     }
  //   }
  //   validateMinSalePriceByTotalAmt(value, totalAmt, lsTotalAmt, nettAmt = null) {
  ...
  //   }
  //   changeDisPer(event, discountAmt = null, nettAmt = null) {
  ...
  //     }
  //   }
  //   changeTotalAmt(event, nettAmt = null) {
  ...
  //   setValToLocalStorage(event, name) {
  //     let checkStockCostVal =
  //       parseFloat(this.lineItemForm.value.fcn_li_net_amount) /
  //       parseFloat(this.lineItemForm.value.fcn_li_gross_wt);
  ...
  //   changeGrossFunc(totalAmt, grossAmt) {
  ...
  //   changeDisAmount(event, nettAmt = null) {
  //     if (event.target.value != '') {
  //       const value =
  //         // (
  //         //   (this.lineItemForm.value.fcn_li_discount_amount /
  ...
  //   }
  //   setMetalRate(karatCode) {
  //     const value = this.karatRateDetails.filter(
  //       (data) => data.KARAT_CODE == karatCode
  //     )[0].KARAT_RATE;
  ...
  //       this.retailSalesDataPost.estimationDetail.forEach((data) => {
  ...
  //         this.retailSReturnDataPost.retailSReturnDetails.forEach((data) => {
  //           data.DTSALESPERSON_CODE = this.vocDataForm.value.sales_person || '';
  //           data.SALESPERSON_CODE = this.vocDataForm.value.sales_person || '';
  //         });
  //     }
  ...
  //   getYearList() {
  //     this.suntechApi
  //       .getUFinancialYear(this.strBranchcode, this.strUser)
  //       .subscribe((resp) => {
  //         var data = resp.response.map((t) => t.fyearcode);
  ...
  //   getAccountLookup() {
  //     this.suntechApi.getAccountLookup().subscribe((resp) => {
  //       let resVal;
  //       if (resp['status'] == 'Success') {
  ...
  //     this.receiptDetailsList.forEach((item) => {
  //       totalNetAmount =
  ...
  //   editReceiptItem(index, data) {
  //     this.receiptEditId = data['SRNO'];
  //     const resmode = this.receiptModesTypes
  //       .filter((ele) => ele['CREDIT_CODE'] == data['RECEIPT_MODE'])
  //     let modeIndex;
  //     if (resmode.length > 0)
  ...
  //   changeAdvanceVocNo(event) {
  
  //     this.suntechApi
  //       .getAdvanceReceiptDetail(this.advanceReceiptForm.value.advanceBranch, 'PCR', this.advanceReceiptForm.value.advanceRecNo, this.advanceReceiptForm.value.advanceYear)
  //       .subscribe((res) => {
  //         if (res['status'] == 'Success') {
  //           this.advanceReceiptForm.controls.advanceAmount.setValue(
  ...
  //   }
  //   changeReceiptAmtFC(event, formName, fieldName) {
  ...
  //   getCityMasterByID(countryCode, stateCode) {
  
  //     this.suntechApi.getGeneralMaster('CITY MASTER', countryCode, stateCode).
  //       subscribe(async data => {
  //         if (data.status == "Success") {
  ...
  //   getStateMasterByID(countryCode) {
  //     this.suntechApi.getGeneralMaster('STATE MASTER', countryCode).
  //       subscribe(async data => {
  //         if (data.status == "Success") {
