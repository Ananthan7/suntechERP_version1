...
export class DiamonBranchTransferOutDetailsComponent implements OnInit {
  ...
  formSubmit() {
    ...
    let postData = {
      ...
      "SUPPLIER": "",
      "PCS": this.diamondbranchtransoutdetailForm.value.pieces,
      ...
      "STONEVALUEFC": 0,
      "STONEVALUECC": 0,
      "DISCPER": this.diamondbranchtransoutdetailForm.value.percentage,
      "DISCAMTFC": this.diamondbranchtransoutdetailForm.value.disc_amount,
      "DISCAMTCC": 0,
      "NETVALUEFC": 0,
      "NETVALUECC": 0,
      "PUDIFF": 0,
      ...
      "ITEM_CURRENCY_D": "",
      "ITEM_CURR_RATE_D": 0,
      "D_REMARKS": this.diamondbranchtransoutdetailForm.value.remarks,
      "IMPYEARMONTH": "",
      "IMPVOCTYPE": "",
      "IMPVOCNO": 0,
      "IMPBATCHNO": 0,
      "IMPMID": 0,
      "RUBY_WT": 0,
      "RUBY_AMOUNTFC": this.diamondbranchtransoutdetailForm.value.value_amount,
      "RUBY_AMOUNTCC": 0,
      "EMERALD_WT": 0,
      "EMERALD_AMOUNTFC": 0,
      "EMERALD_AMOUNTCC": 0,
      ...
      "DIFAMTFC": 0,
      "SUPPLIER_REF": "",
      "TOTAL_AMOUNTFC": this.diamondbranchtransoutdetailForm.value.total_fc,
      "TOTAL_AMOUNTCC": this.diamondbranchtransoutdetailForm.value.total_cc,
      ...
      "SGST_ACCODE": "",
      "IGST_ACCODE": "",
      "GST_ROUNDOFFFC": this.diamondbranchtransoutdetailForm.value.round,
      "GST_ROUNDOFFCC": 0,
      "ROUNDOFF_ACCODE": "",
      ...
      "FINEGOLD": 0,
      "MASTERFINEGOLD": 0,
      "DIAMOND_RATEFC": this.diamondbranchtransoutdetailForm.value.rate,
      "DIAMOND_RATELC": 0,
      "DIAMOND_VALUEFC": this.diamondbranchtransoutdetailForm.value.amt,
      "DIAMOND_VALUELC": 0,
      "COLORSTONE_RATEFC": 0,
      "COLORSTONE_RATELC": 0,
      ...
      "WASTAGE": 0,
      "WASTAGEPER": 0,
      "WASTAGEAMOUNTFC": this.diamondbranchtransoutdetailForm.value.amount2,
      "WASTAGEAMOUNTLC": 0,
      "PEARL_PCS": 0,
      "PEARL_WT": 0,
      "PEARL_AMTFC": 0,
