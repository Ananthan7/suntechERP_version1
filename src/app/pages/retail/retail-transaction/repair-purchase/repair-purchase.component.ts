...
formSubmit(){
  ...
  if (this.repairpurchaseForm.invalid) {
  ...
  let postData = {
    ...
    "VOCTYPE": this.repairpurchaseForm.value.voc_type,
    "VOCNO": this.repairpurchaseForm.value.voc_no,
    "VOCDATE": this.repairpurchaseForm.value.Voc_date,
    "YEARMONTH": this.yearMonth,
    "PARTYCODE": this.repairpurchaseForm.value.partyCode,
    "PARTY_CURRENCY": this.repairpurchaseForm.value.partycur,
    "PARTY_CURR_RATE": this.repairpurchaseForm.value.partycurrate,
    "ITEM_CURRENCY": "stri",
    "ITEM_CURR_RATE": 0,
    "VALUE_DATE": "2024-03-23T04:51:34.662Z",
    "SALESPERSON_CODE": this.repairpurchaseForm.value.name,
    "RATE_TYPE": "string",
    "METAL_RATE": this.repairpurchaseForm.value.metal_rate,
    "FIXED": this.repairpurchaseForm.value.fixed_pure,
    "TOTAL_PCS": 0,
    "TOTAL_GRWT": 0,
    "TOTAL_PUWT": 0,
    "TOTAL_MKGVALUE_FC": 0,
    ...
    "ADDL_VALUE_FC": 0,
    "ADDL_VALUE_CC": 0,
    "GROSS_VALUE_FC":this.repairpurchaseForm.value.gross_total_fc,
    "GROSS_VALUE_CC": this.repairpurchaseForm.value.gross_total_cc,
    "REMARKS": this.repairpurchaseForm.value.remarks,
    ...
    "MACHINEID": "string",
    "SALESPERSON_NAME": this.repairpurchaseForm.value.namedes,
    "TOTAL_WASTQTY": 0,
    "TOTAL_AMT_FC": 0,
    "PARTYADDRESS": this.repairpurchaseForm.value.Address,
    "CREDITDAY": this.repairpurchaseForm.value.credit_days_LC,
    "AUTOPOSTING": true,
    "POSTDATE": "string",
    ...
    "GST_GROUP": "s",
    "FIXING_PROCESS": true,
    "TOTAL_ADDL_TAXFC": this.repairpurchaseForm.value.total_tax_fc,
    "TOTAL_ADDL_TAXCC": this.repairpurchaseForm.value.total_tax_cc,
    ...
    "TDS_CODE": this.repairpurchaseForm.value.total_TDS,
    "TDS_APPLICABLE": true,
    "TDS_TOTALFC": 0,
    "TDS_TOTALCC": 0,
    "H_DECLARATIONNO": this.repairpurchaseForm.value.declaration_no,
    "H_ORIGINCOUNTRY": this.repairpurchaseForm.value.country_origin_des,
    "H_DECLARATIONDATE": this.repairpurchaseForm.value.declaration_date,
    "H_PACKETNO": this.repairpurchaseForm.value.packet_no,
    "SHIPPER_CODE": "string",
    "SHIPPER_NAME": "string",
    "ORIGIN_COUNTRY": this.repairpurchaseForm.value.country_origin,
    ...
    "PARTY_ROUNDOFF": this.repairpurchaseForm.value.party_round_Off,
    ...
    "SHIPDESC": "string",
    "STAMPCHARGE": true,
    "TOTSTAMP_AMTFC": this.repairpurchaseForm.value.stamp_Amt_FC,
    "TOTSTAMP_AMTCC":this.repairpurchaseForm.value.stamp_Amt_CC,
    "TOTSTAMP_PARTYAMTFC": this.repairpurchaseForm.value.stamp_party_Amt,
    "REFPURIMPORT": "string",
    "BOE_EXPIRY_DATE": this.repairpurchaseForm.value.expiry_date,
    "H_BILLOFENTRYREF": "string",
    "SUB_LED_ACCODE": this.repairpurchaseForm.value.sub_ledger,
    "ACTIVITY_CODE": "string",
    "TCS_ACCODE": this.repairpurchaseForm.value.total_TCS,
    "TCS_AMOUNT": 0,
    "TCS_AMOUNTCC": 0,
    "TCS_APPLICABLE": true,
    "DISCOUNTPERCENTAGE": 0,
    "CUSTOMER_ADDRESS": this.repairpurchaseForm.value.Navigation,
    "FROM_TOUCH": true,
    "CUSTOMER_CODE": this.repairpurchaseForm.value.Customer,
    ...
    "DISPATCH_ZIPCODE": 0,
    "EWAY_TRANS_TYPE": "s",
    "CREDIT_DAYSMTL": this.repairpurchaseForm.value.credit_days_Mtl,
    "VALUE_DATEMTL": this.repairpurchaseForm.value.credit_date_Mtl,
    ...
    "ITEMROUNDVALUEFC": 0,
    "NEWMID": 0,
    "PARTYROUNDVALUEFC": this.repairpurchaseForm.value.round_to,
...
update(){
  ...
  let API = 'Repair/UpdateRepair/'+ this.branchCode + this.repairpurchaseForm.value.voctype + this.repairpurchaseForm.value.vocno + this.yearMonth
  let postData = {
    "MID": 0,
    "BRANCH_CODE": "string",
    "VOCTYPE": "str",
...
deleteRecord() {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      let API = 'Repair/DeleteRepair/' + this.branchCode + this.repairpurchaseForm.value.voctype + this.repairpurchaseForm.value.vocno + this.yearMonth
