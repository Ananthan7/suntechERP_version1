...
export class AddReceiptComponent implements OnInit {
  ...
  setvaluesEdited() {
    ...
    this.receiptEntryForm.controls.IGST_ACCODE.setValue(this.content.IGST_ACCODE)
  ...
  setInitialValues() {
    ...
    this.setFormControlAmount('Amount_FC', data.AMOUNTFC)
    this.setFormControlAmount('Amount_LC', data.AMOUNTCC)
    this.setFormControlAmount('Header_Amount', data.AMOUNTCC)
    ...
    this.receiptEntryForm.controls.ChequeNumber.setValue(data.CHEQUE_NO)
    this.receiptEntryForm.controls.DrawnBank.setValue(data.CHEQUE_BANK)
    this.receiptEntryForm.controls.TypeCode.setValue(data.MODE)
    this.receiptEntryForm.controls.TypeCodeDESC.setValue(data.MODEDESC)
    this.receiptEntryForm.controls.ChequeDate.setValue(data.CHEQUE_DATE)
      ...
      .subscribe((result) => {
        if (result.status == "Success") {
          ...
          this.gridDataSource.forEach((item: any) => {
            ...
            item.PAY_DATE = this.commonService.formatDDMMYY(new Date(item.PAY_DATE))
          })
          this.setCommaInGrid()
