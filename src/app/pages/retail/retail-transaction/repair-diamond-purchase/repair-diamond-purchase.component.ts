...
export class RepairDiamondPurchaseComponent implements OnInit {
  ...
  getrepairpurchasedetails(e:any){
    ...
    this.repairdiapurchaseForm.controls.Voc_date.setValue(e.VOCDATE);
    ...
    //this.repairdiapurchaseForm.controls.remarks.setValue(e.GST_TYPE);
    this.repairdiapurchaseForm.controls.total_tax_fc.setValue(e.TOTAL_ADDL_TAXFC);
    //this.repairdiapurchaseForm.controls.remarks.setValue(e.DELIVERY_DATE);
    ...
    this.repairdiapurchaseForm.controls.declaration_date.setValue(e.H_DECLARATIONDATE);
...
openaddalloyallocation() {
  ...
  formSubmit() {
    ...
    let postData = {
      ...
      "REPAIR_REF": "string",
      "GENSEQNO": 0,
      "Detail": this.repairDiaPurchaseDetailsData
      // [
        // {
        //   "UNIQUEID": 0,
        //   "SRNO": 0,
