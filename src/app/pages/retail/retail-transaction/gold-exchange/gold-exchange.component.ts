...
export class GoldExchangeComponent implements OnInit {
 ...
 salesManCodeSelected(e:any){
  ...
  setFormValues(){
    ...
    this.goldExchangeForm.controls.custName.setValue(this.content.HLOCTYPE_CODE);
    this.goldExchangeForm.controls.customer.setValue(this.content.HTUSERNAME);
  ...
  formSubmit(){
    ...
    let postData = {
      ...
      "REP_REF": "string",
      "REPAIR_REF": "string",
      "HLOCTYPE_CODE": this.goldExchangeForm.value.custName,
      "HTUSERNAME": this.goldExchangeForm.value.customer,
      "MHIDCATEGORY": "string",
