...
export class GoldExchangeComponent implements OnInit {
  ...
  formSubmit() {
    ...
    let postData = {
      ...
      "TOTAL_PUDIFF": 0,
      "TOTAL_STONEDIFF": 0,
      "ITEM_VALUE_FC": this.comService.decimalQuantityFormat(this.goldExchangeForm.value.rndOfAmt, 'AMOUNT') ?? "0.00",
      "ITEM_VALUE_CC": this.comService.decimalQuantityFormat(this.goldExchangeForm.value.rndOfAmtDes, 'AMOUNT'),
      "PARTY_VALUE_FC": 0,
      "PARTY_VALUE_CC": 0,
      "NET_VALUE_FC": this.comService.decimalQuantityFormat(this.goldExchangeForm.value.rndNetAmt, 'AMOUNT') ?? "0.00",
      "NET_VALUE_CC": this.comService.decimalQuantityFormat(this.goldExchangeForm.value.rndNetAmtDes, 'AMOUNT'),
      "ADDL_VALUE_FC": this.comService.decimalQuantityFormat(this.goldExchangeForm.value.otherAmt, 'AMOUNT') ?? "0.00",
      "ADDL_VALUE_CC": this.comService.decimalQuantityFormat(this.goldExchangeForm.value.otherAmtDes, 'AMOUNT'),
      "GROSS_VALUE_FC": this.comService.decimalQuantityFormat(this.goldExchangeForm.value.grossAmt, 'AMOUNT') ?? "0.00",
      ...
      "SHIPDESC": "",
      "STAMPCHARGE": true,
      "TOTSTAMP_AMTFC": this.comService.decimalQuantityFormat(this.goldExchangeForm.value.amount, 'AMOUNT') ?? "0.00",
  ...
  update() {
    ...
    let updateData = {
      ...
      "TOTAL_PUDIFF": 0,
      "TOTAL_STONEDIFF": 0,
      "ITEM_VALUE_FC": this.goldExchangeForm.value.rndOfAmt ?? "0.00",
      "ITEM_VALUE_CC": this.goldExchangeForm.value.rndOfAmtDes,
      "PARTY_VALUE_FC": 0,
      "PARTY_VALUE_CC": 0,
      "NET_VALUE_FC": this.goldExchangeForm.value.rndNetAmt ?? "0.00",
      "NET_VALUE_CC": this.goldExchangeForm.value.rndNetAmtDes,
      "ADDL_VALUE_FC": this.goldExchangeForm.value.otherAmt ?? "0.00",
