...
export class GoldExchangeDetailsComponent implements OnInit {
  ...
  formSubmit(action?: any) {
    ...
    let postData = {
      ...
      "PCS": this.goldExchangeDetailsForm.value.pieces ?? 0,
      "GROSSWT": this.goldExchangeDetailsForm.value.grossWeight ?? 0,
      "STONEWT": this.goldExchangeDetailsForm.value.stoneWeight ?? 0,
      "NETWT": this.goldExchangeDetailsForm.value.netWeight ?? 0,
      "PURITY": this.goldExchangeDetailsForm.value.purity ?? 0,
      "PUREWT": this.goldExchangeDetailsForm.value.pureWeight ?? 0,
      "CHARGABLEWT": this.goldExchangeDetailsForm.value.chargableWeight ?? 0,
      ...
      "METAL_RATE_GMSFC": 0,
      "METAL_RATE_GMSCC": 0,
      "METALVALUEFC": this.goldExchangeDetailsForm.value.metalRate ?? 0,
      "METALVALUECC": this.goldExchangeDetailsForm.value.metalAmount ?? 0,
      "STONE_RATEFC": 0,
      "STONE_RATECC": 0,
      ...
      "NETVALUECC": this.goldExchangeDetailsForm.value.netAmount ?? 0,
      "PUDIFF": this.goldExchangeDetailsForm.value.purityDiffer ?? 0,
      "STONEDIFF": this.goldExchangeDetailsForm.value.stoneDiffer ?? 0,
      "PONO": 0,
      ...
      "BAGREMARKS": "",
      "WASTAGEPER": this.goldExchangeDetailsForm.value.wastagePercent ?? 0,
      "WASTAGEQTY": this.goldExchangeDetailsForm.value.wastageQuantity ?? 0,
      "WASTAGEAMOUNTFC": this.goldExchangeDetailsForm.value.wastageAmount ?? 0,
      "WASTAGEAMOUNTCC": 0,
      "MKGMTLNETRATE": 0,
      "MCLENGTH": this.goldExchangeDetailsForm.value.unitValue ?? 0,
      ...
      "MKGPREMIUMACCODE": "",
      "DETLINEREMARKS": "",
      "MUD_WT": this.goldExchangeDetailsForm.value.mudWeight ?? 0,
      "JAWAHARAYN": this.goldExchangeDetailsForm.value.jawaharaSelect ?? 0,
      "RESALERECYCLE": this.goldExchangeDetailsForm.value.reSaleCycleSelect ?? 0,
      "CASHEXCHANGE": this.goldExchangeDetailsForm.value.cashExchangeSelect ?? 0,
  ...
  update() {
    ...
    let postData = {
      ...
      "STONE_RATECC": 0,
      "STONEVALUEFC": this.goldExchangeDetailsForm.value.stoneRate ?? 0,
      "STONEVALUECC": this.goldExchangeDetailsForm.value.stoneAmount ?? 0,
      "NETVALUEFC": this.goldExchangeDetailsForm.value.netRate ?? 0,
