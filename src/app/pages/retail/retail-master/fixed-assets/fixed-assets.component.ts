...
export class FixedAssetsComponent implements OnInit {
  ...
  ViewController(DATA: any) {
    ...
    let Sub: Subscription = this.apiService.getDynamicAPI(API).subscribe(
      (result: any) => {
        ...
        this.fixedassetsform.controls.category_code.setValue(
          this.dyndatas.FA_CATEGORY
        );
        this.fixedassetsform.controls.assets_code.setValue(
          this.dyndatas.FA_CODE
        );
        this.fixedassetsform.controls.description.setValue(
          this.dyndatas.FA_DESC
        );
        this.fixedassetsform.controls.method.setValue(
          this.dyndatas.FA_DEP_METHOD
        );
        this.fixedassetsform.controls.life_period.setValue(
          this.dyndatas.FA_DEP_PERCENTAGE
        );
        this.fixedassetsform.controls.cost_lc.setValue(
          this.commonService.decimalQuantityFormat(
            this.dyndatas.FA_COST,
            "AMOUNT"
          )
        );
        this.fixedassetsform.controls.land_cost_lc.setValue(
          this.commonService.decimalQuantityFormat(
            this.dyndatas.FA_LANDEDCOST,
            "AMOUNT"
          )
        );
        this.fixedassetsform.controls.open_net_val.setValue(
          this.commonService.decimalQuantityFormat(
            this.dyndatas.FA_OPN_DEP_AMOUNT,
            "AMOUNT"
          )
        );
        this.fixedassetsform.controls.opening_acc_dep.setValue(
          this.commonService.decimalQuantityFormat(
            this.dyndatas.FA_ACC_DEP_AMOUNT,
            "AMOUNT"
          )
        );
        this.fixedassetsform.controls.start_from.setValue(
          this.dyndatas.FA_START_DEP_DATE
        );
        this.fixedassetsform.controls.last_dep_date.setValue(
          this.dyndatas.FA_LAST_DEP_DATE
        );
        this.fixedassetsform.controls.purchase_inv.setValue(
          this.dyndatas.FA_PUR_VOCNO
        );
        this.fixedassetsform.controls.supp_inv_date.setValue(
          this.dyndatas.FA_PUR_VOCDATE
        );
        this.fixedassetsform.controls.supplier_code.setValue(
          this.dyndatas.FA_SUPPLIER
        );
        this.fixedassetsform.controls.disposal_date.setValue(
          this.dyndatas.FA_DISPOSAL_DATE
        );
        this.fixedassetsform.controls.remarks.setValue(
          this.dyndatas.FA_DISPOSAL_REMARKS
        );
        this.fixedassetsform.controls.created_by.setValue(
          this.dyndatas.FA_CREATEDBY
        );
        this.fixedassetsform.controls.created_on.setValue(
          this.dyndatas.FA_CREATEDTIME
        );
        this.fixedassetsform.controls.Branchcode.setValue(
          this.dyndatas.FA_BRANCHCODE
        );
        this.fixedassetsform.controls.department_code.setValue(
          this.dyndatas.FA_DEPARTMENT
        );
        this.fixedassetsform.controls.loc_code.setValue(
          this.dyndatas.FA_LOCATION
        );
        this.fixedassetsform.controls.used_by_code.setValue(
          this.dyndatas.FA_USEDBY
        );
        this.fixedassetsform.controls.category_code_desc.setValue(
          this.dyndatas.FA_DET_CATEGORY
        );
        this.fixedassetsform.controls.status.setValue(
          this.dyndatas.FA_ACTIVESTATUS
        );
        this.fixedassetsform.controls.warranty.setValue(
          this.dyndatas.FA_WARRANTYUPTO_DATE
        );
        this.fixedassetsform.controls.service_upto.setValue(
          this.dyndatas.FA_SERVICECTRLUPTO_DATE
        );
        this.fixedassetsform.controls.insurance_upto.setValue(
          this.dyndatas.FA_INSURANCEUPTO_DATE
        );
        this.fixedassetsform.controls.reg_upto.setValue(
          this.dyndatas.FA_REGISTRATIONUPTO_DATE
        );
        this.fixedassetsform.controls.certi_upto.setValue(
          this.dyndatas.FA_CERTIFICATIONUPTO_DATE
        );
        this.fixedassetsform.controls.reg_no.setValue(this.dyndatas.FA_REGNO);
        this.fixedassetsform.controls.insurance.setValue(
          this.dyndatas.FA_INSURANCE
        );
        this.fixedassetsform.controls.certi_no.setValue(
          this.dyndatas.FA_CERTIFICATIONNO
        );
        this.fixedassetsform.controls.install_dt.setValue(
          this.dyndatas.FA_INSTALLATION_DETAILS
        );
        this.fixedassetsform.controls.costfc.setValue(
          this.commonService.decimalQuantityFormat(
            this.dyndatas.FA_COST_FC,
            "AMOUNT"
          )
        );
        this.fixedassetsform.controls.curr_rate.setValue(
          this.commonService.decimalQuantityFormat(
            this.dyndatas.FA_CONV_RATE,
            "RateDecimalInput"
          )
        );
        // this.fixedassetsform.controls.curr_rate.setValue(this.dyndatas.FA_CONV_RATE);
        this.fixedassetsform.controls.curr_code.setValue(
          this.dyndatas.FA_CURRENCY
        );
        this.fixedassetsform.controls.months.setValue(
          this.dyndatas.FA_DEP_PERIOD
        );
        this.fixedassetsform.controls.userdefined_1.setValue(
          this.dyndatas.UDF1
        );
        this.fixedassetsform.controls.userdefined_2.setValue(
          this.dyndatas.UDF2
        );
        this.fixedassetsform.controls.userdefined_3.setValue(
          this.dyndatas.UDF3
        );
        this.fixedassetsform.controls.userdefined_4.setValue(
          this.dyndatas.UDF4
        );
        this.fixedassetsform.controls.userdefined_5.setValue(
          this.dyndatas.UDF5
        );
        // this.flag = "EDIT";
      },
  ...
  formSubmit() {
    const postData = {
      MID: 0,
      FA_CATEGORY: this.commonService.nullToString(
        this.fixedassetsform.controls.category_code.value
      ),
      FA_CODE: this.commonService.nullToString(
        this.fixedassetsform.controls.assets_code.value
      ),
      FA_DESC: this.commonService.nullToString(
        this.fixedassetsform.controls.description.value
      ),
      FA_MSTORADDITION: "string",
      FA_DEP_METHOD: this.commonService.nullToString(
        this.fixedassetsform.controls.method.value
      ),
      FA_DEP_PERCENTAGE: this.commonService.emptyToZero(
        this.fixedassetsform.controls.life_period.value
      ),
      FA_CALCULATION_METHOD: "string",
      FA_CM_LENGTH_MONTH: 0,
      FA_NO_OF_PCS: 0,
      FA_COST: this.commonService.emptyToZero(
        this.fixedassetsform.controls.cost_lc.value
      ),
      FA_LANDEDCOST: this.commonService.emptyToZero(
        this.fixedassetsform.controls.land_cost_lc.value
      ),
      FA_OPN_DEP_AMOUNT: this.commonService.emptyToZero(
        this.fixedassetsform.controls.open_net_val.value
      ),
      FA_ACC_DEP_AMOUNT: this.commonService.emptyToZero(
        this.fixedassetsform.controls.opening_acc_dep.value
      ),
      ...
      FA_PUR_VOCNO: this.commonService.nullToString(
        this.fixedassetsform.controls.purchase_inv.value
      ),
      FA_PUR_VOCDATE: this.fixedassetsform.controls.supp_inv_date.value,
      FA_SUPPLIER: this.commonService.nullToString(
        this.fixedassetsform.controls.supplier_code.value
      ),
      FA_PUR_AMOUNT: 0,
      FA_DISPOSAL_DATE: this.fixedassetsform.controls.disposal_date.value,
      FA_DISPOSAL_REMARKS: this.commonService.nullToString(
        this.fixedassetsform.controls.remarks.value
      ),
      FA_CREATEDBY: this.commonService.nullToString(
        this.fixedassetsform.controls.created_by.value
      ),
      FA_CREATEDTIME: this.fixedassetsform.controls.created_on.value,
      FA_BRANCHCODE: this.commonService.nullToString(
        this.fixedassetsform.controls.Branchcode.value
      ),
      FA_DEPARTMENT: this.commonService.nullToString(
        this.fixedassetsform.controls.department_code.value
      ),
      FA_DIVISION: "string",
      FA_LOCATION: this.commonService.nullToString(
        this.fixedassetsform.controls.loc_code.value
      ),
      FA_USEDBY: this.commonService.nullToString(
        this.fixedassetsform.controls.used_by_code.value
      ),
      FA_DET_CATEGORY: this.commonService.nullToString(
        this.fixedassetsform.controls.category_code_desc.value
      ),
      FA_ACTIVESTATUS: this.commonService.nullToString(
        this.fixedassetsform.controls.status.value
      ),
      FA_IMAGEPATH: "string",
      ...
      FA_REGNO: this.commonService.nullToString(
        this.fixedassetsform.controls.reg_no.value
      ),
      FA_INSURANCE: this.commonService.nullToString(
        this.fixedassetsform.controls.insurance.value
      ),
      FA_CERTIFICATIONNO: this.commonService.nullToString(
        this.fixedassetsform.controls.certi_no.value
      ),
      FA_INSTALLATION_DETAILS: this.commonService.nullToString(
        this.fixedassetsform.controls.install_dt.value
      ),
      FA_COST_FC: this.commonService.emptyToZero(
        this.fixedassetsform.controls.costfc.value
      ),
      FA_CONV_RATE: this.commonService.emptyToZero(
        this.fixedassetsform.controls.curr_rate.value
      ),
      FA_CURRENCY: this.commonService.nullToString(
        this.fixedassetsform.controls.curr_code.value
      ),
      FA_DEP_PERIOD: this.commonService.emptyToZero(
        this.fixedassetsform.controls.months.value
      ),
      UDF1: this.commonService.nullToString(
        this.fixedassetsform.controls.userdefined_1.value
      ),
      UDF2: this.commonService.nullToString(
        this.fixedassetsform.controls.userdefined_2.value
      ),
      UDF3: this.commonService.nullToString(
        this.fixedassetsform.controls.userdefined_3.value
      ),
      UDF4: this.commonService.nullToString(
        this.fixedassetsform.controls.userdefined_4.value
      ),
      UDF5: this.commonService.nullToString(
        this.fixedassetsform.controls.userdefined_5.value
      ),
    };
