...
export class FixedAssetsComponent implements OnInit {
  ...
  setCompanyCurrency() {
    ...
    this.fixedassetsform.controls.curr_code.setValue(CURRENCY_CODE);
    ...
    if (this.commonService.allBranchCurrency && this.commonService.allBranchCurrency.length > 0) {
      ...
      if (CURRENCY_RATE.length > 0) {
        this.fixedassetsform.controls.curr_rate.setValue(this.commonService.decimalQuantityFormat(CURRENCY_RATE[0].CONV_RATE, 'RATE'));
      } else {
