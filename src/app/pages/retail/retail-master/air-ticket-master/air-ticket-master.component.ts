...
export class AirTicketMasterComponent implements OnInit {
  ...
  setFormValues() {
    ...
    let api = "PayTicketSchemeMaster/GetPayTicketSchemeMasterWithCode/" + this.content.CODE;
    console.log(api);
    ...
    this.AirTicketMasterForm.controls.code.setValue(
      this.content.CODE
    );
    this.AirTicketMasterForm.controls.description.setValue(
      this.content.DESCRIPTION
    );
    this.AirTicketMasterForm.controls.debit.setValue(
    ...
    this.AirTicketMasterForm.controls.in.setValue(
      this.content.NO_OF_MONTHS
    );

    this.AirTicketMasterForm.controls.userDefined1.setValue(
      this.data?.UDF1
    );
    this.AirTicketMasterForm.controls.userDefined2.setValue(
      this.content?.UDF2
    );
    this.AirTicketMasterForm.controls.userDefined3.setValue(
      this.data?.UDF3
    );
    this.AirTicketMasterForm.controls.userDefined4.setValue(
      this.data?.UDF4
    );
    this.AirTicketMasterForm.controls.userDefined5.setValue(
      this.data?.UDF5
    );
    this.AirTicketMasterForm.controls.userDefined6.setValue(
      this.data?.UDF6
    );
    this.AirTicketMasterForm.controls.userDefined7.setValue(
      this.data?.UDF7
    );
    this.AirTicketMasterForm.controls.userDefined8.setValue(
      this.data?.UDF8
    );
    this.AirTicketMasterForm.controls.userDefined9.setValue(
      this.data?.UDF9
    );
    this.AirTicketMasterForm.controls.userDefined10.setValue(
      this.data?.UDF10
    );
    this.AirTicketMasterForm.controls.userDefined11.setValue(
      this.data?.UDF11
    );
    this.AirTicketMasterForm.controls.userDefined12.setValue(
      this.data?.UDF12
    );
    this.AirTicketMasterForm.controls.userDefined13.setValue(
      this.data?.UDF13
    );
    this.AirTicketMasterForm.controls.userDefined14.setValue(
      this.data?.UDF14
    );
    this.AirTicketMasterForm.controls.userDefined15.setValue(
      this.data?.UDF15
    );
  }
  setPostData() {
    let form = this.AirTicketMasterForm.value;
    let postData = {
  ...
  formSubmit() {
    ...
    let API = "PayTicketSchemeMaster/InsertPayTicketSchemeMaster";
          ...
          if (result.response) {
            if (result.status == "Success") {
              Swal.fire({
                ...
                if (result.value) {
                  this.AirTicketMasterForm.reset();
                  this.tableData = [];
  ...
  updateMaster() {
    let API =
      ...
      this.AirTicketMasterForm.value.code;
    let postData = this.setPostData();
  ...
  deleteRecord() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        let API =
          "PayTicketSchemeMaster/DeletePayTicketSchemeMaster/" + this.content?.CODE;
        let Sub: Subscription = this.dataService
  ...
  UserDefined1DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined1.setValue(e.CODE);
  }
  UserDefined2DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined2.setValue(e.CODE);
  }
  UserDefined3DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined3.setValue(e.CODE);
  }
  UserDefined4DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined4.setValue(e.CODE);
  }
  UserDefined5DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined5.setValue(e.CODE);
  }
  UserDefined6DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined6.setValue(e.CODE);
  }
  UserDefined7DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined7.setValue(e.CODE);
  }
  UserDefined8DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined8.setValue(e.CODE);
  }
  UserDefined9DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined9.setValue(e.CODE);
  }
  UserDefined10DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined10.setValue(e.CODE);
  }
  UserDefined11DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined11.setValue(e.CODE);
  }
  UserDefined12DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined12.setValue(e.CODE);
  }
  UserDefined13DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined13.setValue(e.CODE);
  }
  UserDefined14DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined14.setValue(e.CODE);
  }
  UserDefined15DataSelected(e: any) {
    console.log(e);
    this.AirTicketMasterForm.controls.userDefined15.setValue(e.CODE);
  }
              ...
              if (searchResult?.length) {
                ...
                FORMNAMES.forEach((formName, index) => {
                  ...
                  if (field && field in matchedItem) {
                    ...
                    this.AirTicketMasterForm.controls[formName].setValue(
                      matchedItem[field]
                    );
                  } else {
                    console.error(
  ...
  clearRelevantFields(controllers: string[], LOOKUPDATA: MasterSearchModel) {
    controllers.forEach((controllerName) => {
      const control = this.AirTicketMasterForm.controls[controllerName];
      if (control) {
        control.setValue("");
      } else {
