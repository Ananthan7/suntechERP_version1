...
export class CostcentreMagkingchargesComponent implements OnInit {
  ...
  columnhead: any[] = ['UNIQUE_ID', 'COST_CODE', 'TYPE', 'BRANCH_CODE', 'ADJUSTMENT', 'SALES', 'SALESRETURN', 'PURCHASE', 'PURCHASERETURN', 'STONEVALUE', 'STONEDIFF', 'PURITYDIFF',
   ...
   'SALES_GST', 'BRANCH_TRANSFER_GST', 'DIAPUR_FIXED_GST', 'DIAPUR_FIXED_GST', 'DIAPUR_UNFIXE_WASTAGE', 'DIASAL_UNFIXE_WASTAGE', 'UNFIXPURCHASE', 'UNFIXSALE', 'UNFIXSUPPLIERCTRLAC', 'UNFIXCUSTOMERLAC', 'REPAIRSALESRETURN', 'REPAIRSALES', 'REPUNFIXPURCHASE',
