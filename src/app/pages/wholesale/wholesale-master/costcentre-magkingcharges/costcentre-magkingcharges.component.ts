...
export class CostcentreMagkingchargesComponent implements OnInit {
  ...
  columnhead: any[] = ['UNIQUE_ID', 'COST_CODE', 'TYPE', 'BRANCH_CODE', 'ADJUSTMENT', 'SALES', 'SALESRETURN', 'PURCHASE', 'PURCHASERETURN', 'STONEVALUE', 'STONEDIFF', 'PURITYDIFF',
   ...
   'SALES_GST', 'BRANCH_TRANSFER_GST',  'DIAPUR_FIXED_GST', 'DIAPUR_UNFIXE_WASTAGE', 'DIASAL_UNFIXE_WASTAGE', 'UNFIXPURCHASE', 'UNFIXSALE', 'UNFIXSUPPLIERCTRLAC', 'UNFIXCUSTOMERLAC', 'REPAIRSALESRETURN', 'REPAIRSALES', 'REPUNFIXPURCHASE',
   'KUNDANVALUESALES', 'KUNDANVALUEPURCHASE', 'DIAPUR_UNFIX_VALUE', 'DIASAL_UNFIX_VALUE', 'OPENING_GOLD_DIAJEW', 'REFINE_CHARGES', 'WASTAGEONSALES', 'CERT_CHARGES', 'PLATE_CHARGES', 'STAMPCHARGE_PURCHASEAC', 'STAMPCHARGE_SALESAC', 'DIAPUR_UNFIX_LOOSE', 'DIAPUR_UNFIX_COLOR',
   'DIAPUR_UNFIX_LABOUR', 'DIASAL_UNFIX_LOOSE', 'DIASAL_UNFIX_COLOR', 'DIASAL_UNFIX_PEARL', 'DIASAL_UNFIX_LABOUR', 'KUNDANVALUEOPENING', 'CUSTOME_ACCODE', 'BRIN_UNFIX_GOLD', 'BROUT_UNFIX_GOLD', 'BRIN_FIX_GOLD', 'BROUT_FIX_GOLD', 'BRIN_LOOSE_STONE', 'BROUT_LOOSE_STONE',
   'BRIN_COLOR_STONE', 'BROUT_COLOR_STONE', 'BRIN_WASTAGE', 'BROUT_LABOUR', 'DIAIMPORTPUR_UNFIX', 'DIAIMPORTPUR_FIXED_GOLD', 'DIAIMPORTPUR_UNFIX_LOOSE', 'DIAIMPORTPUR_UNFIX_COLOR', 'DIAIMPORTPUR_UNFIX_PEARL', 'DIAIMPORTPUR_UNFIX_LABOUR', 'DIAIMPORTPUR_UNFIXED_WASTEAGE', 'DIAREPAIRPUR_UNFIX', 'DIAREPAIRPUR_FIXED_GOLD',
   'DIAREPAIRPUR_UNFIX_LOOSE', 'DIAREPAIRPUR_UNFIX_COLOR', 'DIAREPAIRPUR_UNFIX_LABOUR', 'DIAREPAIRPUR_UNFIX_WASTAGE', 'DIARETAILSAL_UNFIX', 'DIARETAILSAL_UNFIX_LOOSE', 'DIARETAILSAL_UNFIX_COLOR', 'DIARETAILSAL_UNFIX_PEARL', 'DIARETAILSAL_UNFIX_LABOUR', 'DIARETAILSAL_UNFIX_WASTEAGE', 'DIAEXPORTSAL_UNFIX', 'DIAEXPORTSAL_FIXED_GOLD', 'DIAEXPORTSAL_UNFIX_LOOSE',
   'DIAEXPORTSAL_UNFIX_COLOR', 'DIAEXPORTSAL_UNFIX_PEARL', 'DIAEXPORTSAL_UNFIX_LABOUR', 'DIAEXPORTSAL_UNFIX_WASTAGE', 'DIAREPAIRSAL_UNFIX', 'DIAREPAIRSAL_FIXED_GOLD', 'DIAREPAIRSAL_UNFIX_LOOSE', 'DIAREPAIRSAL_UNFIX_COLOR', 'DIAREPAIRSAL_UNFIX_PEARL', 'DIAREPAIRSAL_UNFIX_LABOUR', 'DIAREPAIRSAL_UNFIX_WASTAGE', 'DIAEXIBITIONSAL_UNFIX', 'DIAEXIBITIONSAL_FIXED_GOLD',
   'DIAEXIBITIONSAL_UNFIX_LOOSE', 'DIAEXIBITIONSAL_UNFIX_COLOR', 'DIAEXIBITIONSAL_UNFIX_LABOUR', 'DIAEXIBITIONSAL_UNFIX_WASTAGE', 'DIAOTHERSAL_UNFIX', 'DIAOTHERSAL_FIXED_GOLD', 'DIAOTHERSAL_UNFIX_LOOSE', 'DIAOTHERSAL_UNFIX_COLOR', 'DIAOTHERSAL_UNFIX_PEARL', 'DIAOTHERSAL_UNFIX_LABOUR', 'DIAOTHERSAL_UNFIX_WASTEAGE', 'DIA_ALTER_AC', 'SETTINGCHGAC',
   'POLISHINGCHGAC', 'RHODIUMCHGAC', 'LABOURCHGAC', 'MISCCHGAC', 'PLATCHGAC', 'CERTCHGAC', 'OPENING_FIXEDGOLD_DIAJEW', 'DIAOPENING_UNFIX_LOOSE', 'DIAOPENING_UNFIX_COLOR', 'DIAOPENING_UNFIX_PEARL', 'DIAOPENING_UNFIX_LABOUR', 'HEDGESALEFIXING', 'HEDGEPURCHASEFIXING', 'HEDGEMETALPAYMENT', 'HEDGEMETALRECEIPT',];

   CostCenterMakingChargesDetailsData: any[] = [];
  subscriptions: any;
  @Input() content!: any;
  tableData: any[] = [];
  constructor(
  ...
  addTableData() {
    ...
    modalRef.result.then((postData) => {
      ...
      if (postData) {
        ...
        this.CostCenterMakingChargesDetailsData.push(postData);
      }
    });
  ...
  formSubmit() {
    ...
    let postData = {
      ...
      "costCenterDetail": this.CostCenterMakingChargesDetailsData
    }
