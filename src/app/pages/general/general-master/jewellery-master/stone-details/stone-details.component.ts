  ...
  formSubmit(){
    ...
    const postData = {
      UNIQUEID: 0,
          ...
          DESIGN_CODE: "",
          DETLINEREMARKS: this.commonService.nullToString(this.enterStoneDetailsForm.value.StockcodeDes),
          MFTSTOCK_CODE: "",
          STOCK_CODE: this.commonService.nullToString(this.enterStoneDetailsForm.value.Stockcode),
          METALRATE: 0,
