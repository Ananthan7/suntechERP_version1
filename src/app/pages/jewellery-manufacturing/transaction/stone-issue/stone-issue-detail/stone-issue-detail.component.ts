...
export class StoneIssueDetailComponent implements OnInit {
  ...
  columnhead1: any[] = ['Div', 'Stock Code','Batch ID','Stock Bal','Pcs','Carat', 'Location', 'Consigment', 'Rate', 'Amount', 'Other Attributes','Shape','Color','Clarity','Size','Sieve Set','Sieve','Sieve Desc','Remarks','Issued Pcs','Bal.Pcs','Bal.Wt','Pointer Wt','Pcs Variance','Weight Variance'];
