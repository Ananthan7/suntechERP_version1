 ...
 private subscriptions: Subscription[] = [];
  ...
  removedata(){
    ...
    update(){
      ...
      let API = 'JobProcessTrnMasterDJ/UpdateJobProcessTrnMasterDJ/'+ this.processTransferdetailsForm.value.branchCode  + this.processTransferdetailsForm.value.voctype + this.processTransferdetailsForm.value.vocno + this.processTransferdetailsForm.value.vocdate
      let postData = {
        "MID": 0,
        "VOCTYPE": "string",
        "BRANCH_CODE": "string",
    ...
    deleteRecord() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          let API = 'JobProcessTrnMasterDJ/DeleteJobProcessTrnMasterDJ/' + this.processTransferdetailsForm.value.branchCode + this.processTransferdetailsForm.value.voctype + this.processTransferdetailsForm.value.vocno + this.processTransferdetailsForm.value.vocdate
