    ...
    deleteRecord() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          let API = 'JobProcessTrnMasterDJ/DeleteJobProcessTrnMasterDJ/' + this.processTransferFrom.value.branchCode + this.processTransferFrom.value.voctype + this.processTransferFrom.value.vocno + this.processTransferFrom.value.yearMonth
