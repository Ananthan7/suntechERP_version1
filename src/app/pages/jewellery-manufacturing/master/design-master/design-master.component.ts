...
onFileChangedimage(event: any) {
 ...
 updateMeltingType() {
  ...
  parentDesignValidate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'parentDesign')
      return
    }
  }
 ...
 typeValidate(event: any) {
  ...
  styleValidate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'style')
      return
    }
  }
  ...
  vendCustValidate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'vendCust')
      return
    }
  }
  ...
  price1Validate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'price1')
      return
    }
  }

  price2Validate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'price2')
      return
    }
  }

  price3Validate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'price3')
      return
    }
  }

  price4Validate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'price4')
      return
    }
  }

  price5Validate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'price5')
      return
    }
  }
  ...
  collectionValidate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'collection')
      return
    }
  }


  subCollectionCodeDataValidate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'subcollection')
      return
    }
  }


  stoneTypeValidate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'stoneType')
      return
    }
  }

  settingValidate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'setting')
      return
    }
  }
  ...
  incCatValidate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'incCat')
      return
    }
  }

  orderRefValidate(event: any) {
    if (this.viewMode) return
    if (event.target.value == '') {
      this.showOverleyPanel(event, 'orderRef')
      return
    }
  }
