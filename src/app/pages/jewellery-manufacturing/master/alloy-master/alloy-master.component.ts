...
export class AlloyMasterComponent implements OnInit {
  ...
  setPostData(){
    let postData = {
      ...
      STOCK_CODE: "md3",
      STOCK_DESCRIPTION: this.alloyMastereForm.value.description || "",
      CURRENCY_CODE: "stri",
      CC_RATE: 0,
      COST_CODE: this.alloyMastereForm.value.costcenter || "",
      TYPE_CODE: this.alloyMastereForm.value.type || "",
      CATEGORY_CODE: this.alloyMastereForm.value.category || "",
      SUBCATEGORY_CODE: this.alloyMastereForm.value.subcategory || "",
      BRAND_CODE: this.alloyMastereForm.value.brand || "",
      COUNTRY_CODE: this.alloyMastereForm.value.country || "",
      SUPPLIER_CODE: "",
      SUPPLIER_REF: "",
      DESIGN_CODE: this.alloyMastereForm.value.design || "",
      SET_REF: this.alloyMastereForm.value.design || "",
      PICTURE_NAME: "",
      PICTURE_NAME1: this.alloyMastereForm.value.picturename1 || "",
      STOCK_FCCOST: 0,
      STOCK_LCCOST: 0,
      PRICE1PER: this.alloyMastereForm.value.price1 || "",
      PRICE2PER: this.alloyMastereForm.value.price2 || "",
      PRICE3PER: this.alloyMastereForm.value.price3 || "",
      PRICE4PER: this.alloyMastereForm.value.price4 || "",
      PRICE5PER: this.alloyMastereForm.value.price5 || "",
      PRICE1FC: this.alloyMastereForm.value.price1FC || "",
      PRICE1LC: this.alloyMastereForm.value.price1LC || "",
      PRICE2FC: this.alloyMastereForm.value.price2FC || "",
      PRICE2LC: this.alloyMastereForm.value.price2LC || "",
      PRICE3FC: this.alloyMastereForm.value.price3FC || "",
      PRICE3LC: this.alloyMastereForm.value.price3LC || "",
      PRICE4FC: this.alloyMastereForm.value.price4FC || "",
      PRICE4LC: this.alloyMastereForm.value.price4LC || "",
      PRICE5FC: this.alloyMastereForm.value.price5FC || "",
      PRICE5LC: this.alloyMastereForm.value.price5LC || "",
      CHARGE1FC: 0,
      CHARGE1LC: 0,
      CHARGE2FC: 0,
      CHARGE2LC: 0,
      ...
      CLARITY: this.alloyMastereForm.value.clarity || "",
      SIZE: this.alloyMastereForm.value.size || "",
      SIEVE: "",
      SHAPE: "",
      GRADE: "",
      FLUOR: this.alloyMastereForm.value.fluorescence || "",
      FINISH: "",
      CERT_BY: this.alloyMastereForm.value.certificateby || "",
      CERT_NO: this.alloyMastereForm.value.certificateno || "",
      CERT_DATE: this.alloyMastereForm.value.certdate || "",
      GRIDLE: "",
      CULET: "",
      TWIDTH: 0,
      CRHEIGHT: 0,
      PAVDEPTH: 0,
      OVERALL: this.alloyMastereForm.value.overall || "",
      MEASURE: "",
      CERT_PICTURE_NAME: "",
      TAG_LINES: "",
      COMMENTS: "",
      ...
      OPENED_BY: "",
      FIRST_TRN: this.alloyMastereForm.value.fristtransaction || "",
      LAST_TRN: this.alloyMastereForm.value.lasttransaction || "",
      MID: 0,
      PRINTED: true,
      PURVOCTYPE_NO: "",
      PURPARTY: "",
      ...
      PURBRLOC: "",
      SALVOCTYPE_NO: "",
      SALPARTY: this.alloyMastereForm.value.salesman || "",
      ...
      WATCH_WEIGHT: "",
      UNIT: "",
      PCS_PERUNIT: this.alloyMastereForm.value.PCSunit || "",
      TAG_LINESWOENTER: "",
      ...
      CERT_PRINTED: true,
      NOQTYCHANGE: true,
      STYLE: this.alloyMastereForm.value.style || "",
      CUSTOMERSKU: "",
      INITIAL_BRPURVOCTYPE_NO: "string",
      STOCK_DESCRIPTION_OTHERS: this.alloyMastereForm.value.otherdesc || "",
      TIME_CODE: this.alloyMastereForm.value.time || "",
      RANGE_CODE: this.alloyMastereForm.value.range || "",
      COMMENTS_CODE: "",
      NOTES: "",
      ASK: "",
      SELL: "",
      ...
      POLISH: "",
      SYMMETRY: "",
      UDF1: this.alloyMastereForm.value.userdefined_1 || "",
      UDF2: this.alloyMastereForm.value.userdefined_2 || "",
      UDF3: this.alloyMastereForm.value.userdefined_3 || "",
      UDF4: this.alloyMastereForm.value.userdefined_4 || "",
      UDF5: this.alloyMastereForm.value.userdefined_5 || "",
      UDF6: this.alloyMastereForm.value.userdefined_6 || "",
      UDF7: this.alloyMastereForm.value.userdefined_7 || "",
      UDF8: this.alloyMastereForm.value.userdefined_8 || "",
      UDF9: this.alloyMastereForm.value.userdefined_9 || "",
      UDF10: this.alloyMastereForm.value.userdefined_10 || "",
      UDF11: this.alloyMastereForm.value.userdefined_11 || "",
      UDF12: this.alloyMastereForm.value.userdefined_12 || "",
      UDF13: this.alloyMastereForm.value.userdefined_13 || "",
      UDF14: this.alloyMastereForm.value.userdefined_14 || "",
      UDF15: this.alloyMastereForm.value.userdefined_15 || "",
      ...
      TONE_SATURATION: "",
      SHAPEAPPAREL: "",
      DIA_PCS: this.alloyMastereForm.value.diamondsPcs || "",
      DIA_CARAT: this.alloyMastereForm.value.diamondsCarat || "",
      DIA_VALUEFC: this.alloyMastereForm.value.diamondsFC || "",
      DIA_VALUECC: this.alloyMastereForm.value.diamondsLC || "",
      COLOR_PCS: this.alloyMastereForm.value.colorstonePcs || "",
      COLOR_CARAT: this.alloyMastereForm.value.colorstoneCarat || "",
      COLOR_VALUEFC: this.alloyMastereForm.value.colorstoneFC || "",
      COLOR_VALUECC: this.alloyMastereForm.value.colorstoneLC || "",
      PEARL_PCS: this.alloyMastereForm.value.pearlsPcs || "",
      PEARL_CARAT: this.alloyMastereForm.value.pearlsCarat || "",
      PEARL_VALUEFC: this.alloyMastereForm.value.pearlsFC || "",
      PEARL_VALUECC: this.alloyMastereForm.value.pearlsLC || "",
      OTSTONES_PCS: this.alloyMastereForm.value.otstonesPcs || "",
      OTSTONES_CARAT: this.alloyMastereForm.value.otstonesCarat || "",
      OTSTONES_VALUEFC: this.alloyMastereForm.value.otstonesFC || "",
      OTSTONES_VALUECC: this.alloyMastereForm.value.otstonesLC || "",
      METAL_GROSSWT: this.alloyMastereForm.value.metalGrams || "",
      METAL_VALUEFC: this.alloyMastereForm.value.metalFC || "",
      METAL_VALUECC: this.alloyMastereForm.value.metalLC || "",
      TOTPCS: this.alloyMastereForm.value.totalPcs || "",
      TOTCARAT: this.alloyMastereForm.value.totalCarat || "",
      TOTGMS: this.alloyMastereForm.value.totalGrams || "",
      TOTVFC: this.alloyMastereForm.value.totalFC || "",
      TOTVLC: this.alloyMastereForm.value.totalLC || "",
      TOTALFC: 0,
      TOTALCC: 0,
      LAST_EDT_BY: this.alloyMastereForm.value.lasteditby || "",
      LAST_EDT_ON: this.alloyMastereForm.value.lastediton || "",
      UNITCODE: "",
      UNITWT: 0,
      CHKUNIT: true,
      CHKCOMPONENTSUMMARY: "",
      ...
      PARTNER_CODE: "",
      KPNUMBER: "",
      HSN_CODE: this.alloyMastereForm.value.HSNcode || "",
      ITEM_ONHOLD: true,
      POS_CUST_CODE: this.alloyMastereForm.value.POScus || "",
      CONSIGNMENT: true,
      POSGROSSWT: this.alloyMastereForm.value.grossWt || "",
      HANDLING_CHARGEFC: 0,
      HANDLING_CHARGELC: 0,
      ORG_COSTFC: 0,
      ORG_COSTLC: 0,
      ...
      BATCH_PREFIX: "",
      SIEVE_SET: "",
      MODEL_CODE: this.alloyMastereForm.value.modelcode || "",
      NOOF_PLAT: this.alloyMastereForm.value.noofplat || "",
      PLAT_CHARGESFC: 0,
      PLAT_CHARGESLC: 0,
      CERT_CHARGESLC: 0,
      CERT_CHARGESFC: 0,
      ...
      RRR_STOCK_REF: "",
      MARKETCOSTFC: this.alloyMastereForm.value.marketcost || "",
      MARKETCOSTLC: 0,
      ...
      SALES_TAGLINES: "",
      ALLOW_ZEROPCS: true,
      NOOF_CERT: this.alloyMastereForm.value.noofcert || "",
      ADDITIONAL_RATEFC: 0,
      ADDITIONAL_RATELC: 0,
      WBOXWOUTBOX: 0,
      ALLOW_NEGATIVE: true,
      ...
      WT_VAR_PER: 0,
      HALLMARKING: this.alloyMastereForm.value.hallmarking || "",
      WOO_CATEGORY_ID: 0,
      DESIGN_DESC: "",
      COST_CENTER_DESC: "",
      SUPPLIER_DESC: "",
      ORDSALESPERSON_DESC: "",
      COUNTRY_DESC: "",
      TYPE_DESC: this.alloyMastereForm.value.Type || "",
      CATEGORY_DESC: "",
      SUBCATEGORY_DESC: "",
      BRAND_DESC: "",
      COLOR_DESC: "",
