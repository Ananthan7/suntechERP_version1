...
export class ProcessMasterComponent implements OnInit {
  ...
  formSubmit() {
    ...
    let postData = {
      ...
      // "STD_TIME": this.durationPicker.insertTimeFormat(this.processMasterForm.value.stand_time),
      // "MAX_TIME": this.durationPicker.insertTimeFormat(this.processMasterForm.value.max_time),
