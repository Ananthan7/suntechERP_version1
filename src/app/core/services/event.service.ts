...
export class EventService {
    behaviorsubject = new BehaviorSubject({type: '',payload: {}});
    ...
    behaviorBroadcast(type: string, payload = {}) {
        this.behaviorsubject.next({ type, payload });
    }
    ...
    behaviorSubscribe(type: string, callback: EventCallback): Subscription {
